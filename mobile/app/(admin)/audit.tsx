      ...
      <View className="bg-white p-5 rounded-[32px] mb-4 shadow-sm border border-gray-100">
        <View className="flex-row items-start mb-3">
          ...
          <View className="flex-1">
            <View className="flex-row justify-between items-center mb-1">
              <Text className="text-gray-900 font-bold text-sm truncate flex-1 mr-2">
                {item.actorAdmin?.email || "System"}
              </Text>
              <View className="bg-gray-100 px-2 py-0.5 rounded-lg">
                <Text className="text-[9px] font-black uppercase text-gray-500 tracking-wider">
                  {item.action}
                </Text>
              </View>
            </View>
        ...
        <View className="bg-gray-50 p-3 rounded-2xl">
          <Text className="text-gray-600 text-xs leading-5">
            Performed <Text className="font-bold text-gray-900">{item.action}</Text> on {item.entityType}
  ...
  return (
    <View className="flex-1 bg-background-light px-6 pt-16">
      <View className="flex-row items-center mb-6">
        ...
        <Text className="text-2xl font-black text-gray-900">Audit Logs</Text>
      </View>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View className="items-center py-20">
              <ShieldCheck size={48} color="#E2E8F0" className="mb-4" />
              <Text className="text-gray-400 text-center font-bold">No activity logs found</Text>
            </View>
          }
        />
      )}
