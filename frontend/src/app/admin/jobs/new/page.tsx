    ...
    <div className="max-w-5xl mx-auto py-10">
      <div className="mb-10 text-center space-y-2">
         <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-100 text-slate-600 text-xs font-bold uppercase tracking-widest">
            <Zap className="h-3 w-3 fill-slate-400 text-slate-400" />
            Admin Dashboard
         </div>
         ...
         <p className="text-slate-500 font-medium max-w-xl mx-auto">
           Post a new opportunity directly to the platform.
         </p>
      </div>

      {/* Stepper */}
      <div className="mb-12 flex items-center justify-center gap-4 md:gap-8 px-4 max-w-2xl mx-auto">
         {[
                ...
                <div className="grid gap-6 md:grid-cols-2">
                   <div className="space-y-3">
                      ...
                      <Input 
                        ...
                        className="h-14 rounded-2xl bg-white border-slate-200 focus:ring-primary/20 transition-all font-medium text-lg px-6"
                ...
                <div className="space-y-3">
                   <Label className="text-sm font-bold ml-1 text-slate-900">Work Mode</Label>
                      <Select value={formData.workMode} onValueChange={(val) => setFormData({...formData, workMode: val as any})}>
                        <SelectTrigger className="h-14 rounded-2xl bg-white border-slate-200 focus:ring-primary/20 transition-all font-medium text-lg px-6">
                    ...
                    <div className="space-y-3">
                       ...
                       <div className="relative">
                          ...
                          <Input 
                            ...
                            className="h-14 rounded-2xl bg-white border-slate-200 focus:ring-primary/20 transition-all font-medium text-lg pl-12 pr-6"
             ...
             <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
                <div className="space-y-3">
                   ...
                   <Textarea 
                      ...
                      className="min-h-[400px] rounded-[2rem] bg-white border-slate-200 focus:ring-primary/20 transition-all font-medium text-lg p-8 resize-none shadow-inner"
