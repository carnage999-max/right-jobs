...
export function contactFormTemplate(firstName: string, lastName: string, email: string, subject: string, message: string): string {
  return baseLayout("New Contact Request", `
    <div style="text-align: center; margin-bottom: 24px;">
      <div style="display: inline-block; background: #e0f2fe; border-radius: 50%; padding: 16px;">
        <span style="font-size: 32px;">📬</span>
      </div>
    </div>
    <h1 style="font-size: 24px; font-weight: 700; color: #0f172a; margin: 0 0 16px 0; text-align: center;">New Form Submission</h1>
    <p style="margin-bottom: 24px; font-size: 16px;">You have received a new message from the Right Jobs contact form.</p>
    <div style="background: #f8fafc; border-radius: 12px; padding: 24px; margin-bottom: 24px; border: 1px solid #e2e8f0;">
      <p style="margin: 0 0 12px 0; font-size: 14px; color: #64748b;"><strong>From:</strong> <span style="color: #0f172a; font-weight: 600;">${firstName} ${lastName}</span></p>
      <p style="margin: 0 0 12px 0; font-size: 14px; color: #64748b;"><strong>Email:</strong> <span style="color: #0f172a; font-weight: 600;">${email}</span></p>
      <p style="margin: 0 0 12px 0; font-size: 14px; color: #64748b;"><strong>Subject:</strong> <span style="color: #0f172a; font-weight: 600;">${subject}</span></p>
      <div style="margin-top: 16px; padding-top: 16px; border-top: 1px solid #e2e8f0;">
        <p style="margin: 0 0 8px 0; font-size: 14px; color: #64748b;"><strong>Message:</strong></p>
        <p style="margin: 0; font-size: 15px; color: #334155; white-space: pre-wrap;">${message}</p>
      </div>
    </div>
    <p style="margin-bottom: 0; font-size: 12px; color: #94a3b8; text-align: center;">
      This email was generated by the Right Jobs Contact Form.
    </p>
  `);
}
